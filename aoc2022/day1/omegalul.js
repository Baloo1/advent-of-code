...
// read input and group by blank lines node
const input = require("fs").readFileSync("input", "utf8");

const groups = input.split("\n\n").map((group) => group.split("\n"));

// get the sum of each group
const sums = groups.map((group) => group.reduce((acc, cur) => acc + +cur, 0));
...
// get the top three sums
const topThree = sums.sort((a, b) => b - a).slice(0, 3);

// get the sum of the top three sums
